classdef TestAccountUiFromATM < BankingUiTestHelper
    ...
    methods (TestMethodSetup)
        function createTestAccountUi(t)
            ...
            t.app = AccountUi(t.processor, t.srcAccount, 1);
        end 
    end
    ...
    % Test Withdraw
    methods (Test)
        function testWithdrawInsufficientFund(t)
            srcOldAmount = t.srcAccount.query();
            t.type(t.app.withdrawAmountEditField, 100000);
            t.press(t.app.withdrawButton);
            t.verifyEqual(t.app.TextArea.Value{1}, convertStringsToChars(Common.InsufficientFund));
            t.verifyEqual(t.srcAccount.query(), srcOldAmount);            
        end
        function testWithdrawSuccssful(t)
            srcOldAmount = t.srcAccount.query();
            t.type(t.app.withdrawAmountEditField, 200);
            t.press(t.app.withdrawButton);
            t.verifyEqual(t.srcAccount.query(), srcOldAmount - 200);            
        end
    end
